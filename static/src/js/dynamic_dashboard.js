...
export class OdooDynamicDashboard extends Component {
    ...
    onClickAddItem(event){
        ...
        var productId = event.target.getAttribute('data-product-id'); // Get the product_id from the event
        console.log(productId, 'jj')
        if (type == 'graph'){
        ...
        if (type == 'tile'){
            ...
            this.action.doAction({
                ...
                context: {
                    ...
                    'default_product_id': productId // Pass the product_id here
                }
            })
        }
        else {
